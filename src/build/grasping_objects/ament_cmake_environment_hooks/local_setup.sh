...
: ${AMENT_CURRENT_PREFIX:="/workspace/eeee685_finalproject/src/install/grasping_objects"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/grasping_objects/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/grasping_objects/environment/path.sh"
